...
const Recentshows = () => {
  ...
  return (
    <div className="w-full relative p-10  overflow-hidden bg-[#090912] text-white">
      ...
      {/* Marquee Top */}
      <div className="absolute top-30 -left-30 -rotate-40 w-1/2 overflow-hidden rounded-lg p-[2px] bg-gradient-to-r from-black via-blue-500 to-black">
      ...
      {/* Marquee Bottom */}
      <div className="absolute bottom-30 -right-40 -rotate-40 w-1/2 overflow-hidden rounded-lg p-[2px] bg-gradient-to-r from-black via-blue-500 to-black">
        <div className="bg-black w-full py-3 whitespace-nowrap overflow-hidden rounded-md">
          <div
            className={`flex gap-6 animate-marquee`}
            style={{ animationDirection: scrollDirection }}
